...
a = cell_radius;
b = cell_radius;
data1 = get_values(a,b,temp_x,temp_y,center_x,center_y,cell_radius,max_cell_radius,data,i);
...
a = big_cell_radius;
b = big_cell_radius;
data2 = get_values(a,b,temp_x,temp_y,center_x_left,center_y,big_cell_radius,big_cell_radius,data,1);
temp_x = big_cell_radius;
temp_y = 0;
a = big_cell_radius;
b = big_cell_radius;
data3 = get_values(a,b,temp_x,temp_y,center_x_right,center_y,big_cell_radius,big_cell_radius,data,1);
...
%         w = w+1;
%     end
    samp_matrix1 = [data1,randsample(big_merge,sample_size-68,true)];
...
disp(W);
% subplot(2,2,1)
% histogram(sample_avg);
% subplot(2,2,2)
% histogram(sample_std);
% subplot(2,2,3)
% histogram(samp_sum);
% subplot(2,2,4)
% histogram(samp_matrix);