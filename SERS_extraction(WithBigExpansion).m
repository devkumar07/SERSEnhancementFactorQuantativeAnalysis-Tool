...
temp_y = 0;
data2 = get_values1(temp_x,temp_y,center_x_left,center_y,big_cell_radius,max_cell_radius_big,data,1);
temp_x = big_cell_radius;
temp_y = 0;
data3 = get_values1(temp_x,temp_y,center_x_right,center_y,big_cell_radius,max_cell_radius_big,data,1);
